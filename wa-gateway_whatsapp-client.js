...
export class WhatsAppClient {
  ...
  async connect() {
    ...
    this.logger.info({ version, isLatest, sessionDir: this.config.baileys.sessionDir }, 'Starting Baileys socket')
  ...
  handleConnectionUpdate(update) {
    ...
    this.logger.warn({ disconnectCode: this.lastDisconnectCode, shouldReconnect }, 'WhatsApp connection closed')
    if (!shouldReconnect) {
      this.logger.error('Session is logged out. Remove session files and authenticate again to reconnect.')
      return
    }
  ...
  scheduleReconnect() {
    ...
    this.logger.info({ attempt: this.reconnectAttempts, delayMs: delay }, 'Scheduled WhatsApp reconnect')
  }
